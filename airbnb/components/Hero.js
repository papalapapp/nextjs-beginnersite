...
function Hero() {
  return (
    <>
      <div className="container mx-auto flex items-center justify-center h-[686px] relative rounded-none sm:rounded-3xl bg-center bg-cover costum-img mt-2 mb-[104px]">
